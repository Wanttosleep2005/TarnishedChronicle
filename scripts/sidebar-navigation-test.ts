...
check(app.includes('nav-parent-toggle'), '洗点模拟本身应作为单击展开/收起的父级控件');
check(!app.includes('nav-child-toggle'), '不应再使用独立的折叠按钮挤占导航空间');
check(styles.includes('.nav-parent-toggle {'), '父级展开控件应有专用样式');
