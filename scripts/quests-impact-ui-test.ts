...
check(questsPage.includes("import { exportQuestToMarkdown } from '../lib/quest-export.ts'"), 'NPC 页面应接入 Markdown 路线导出');
...
check(questsPage.includes('exportQuestToMarkdown(activeQuest)'), '推演台应导出当前完整任务路线');
